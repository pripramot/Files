...
Files เป็นโปรแกรมจัดการไฟล์ที่ทันสมัย ช่วยให้คุณจัดระเบียบไฟล์และโฟลเดอร์ได้อย่างสะดวก พัฒนาโดยชุมชนโอเพนซอร์ส มาพร้อมฟีเจอร์ที่ครบครัน ไม่ว่าจะเป็นการทำงานหลายอย่างพร้อมกัน แท็กไฟล์ การผสานรวมกับระบบ และการออกแบบที่ใช้งานง่าย

### การติดตั้งและเริ่มต้นใช้งาน

Files เป็นโปรเจกต์ที่ขับเคลื่อนโดยชุมชน หากคุณชอบใช้งาน สามารถสนับสนุนได้ผ่าน Microsoft Store หรือ GitHub

คุณสามารถใช้เวอร์ชันพรีวิวควบคู่ไปกับเวอร์ชันเสถียร เพื่อทดลองฟีเจอร์ใหม่ได้ก่อนใคร

### การมีส่วนร่วมในโครงการ

อยากมีส่วนร่วมกับโครงการนี้ไหม? แจ้งความตั้งใจของคุณผ่าน [Issue](https://github.com/files-community/Files/issues) ก่อนสร้าง [Pull Request](https://github.com/files-community/Files/pulls) ได้เลย ดู[แนวทางการมีส่วนร่วม](https://github.com/files-community/Files/blob/main/.github/CONTRIBUTING.md)เพิ่มเติมได้ที่ลิงก์

### การแปลภาษา

Files รองรับภาษาไทยอย่างเต็มรูปแบบ หากพบข้อความที่ยังไม่ได้แปลหรืออยากช่วยปรับปรุงการแปล สามารถร่วมแปลได้ที่ [Crowdin](https://crowdin.com/project/files-app)
